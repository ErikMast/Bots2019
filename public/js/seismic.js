...
document.addEventListener('DOMContentLoaded', function () {
  ...
  axios.get('./api/v1/seismic/prediction').then(function (response) {
    var mapOptions = {
      zoom: 13,
      center: new google.maps.LatLng(51.5, -0.11)
    };
    var map = new google.maps.Map(document.getElementById("sasdada"), mapOptions);
    ...
    map = new google.maps.Map(document.getElementById('sasdada'), {
      center: sanFrancisco,
      zoom: 9,
      styles: [{
